...
`.png`). `File` writes a value into the thread's scratch project folder — "Reveal in Explorer", "Copy
path". Vendored and available to sandbox code: **three.js**, **p5.js**, **matter.js** (1.8 MB total,
